...
let s:engine = w3m#search_engine#Init('flex', 'https://www.google.com/search?ie=EUC-JP&oe=UTF-8&sitesearch=help.adobe.com/ja_JP/FlashPlatform/reference/actionscript/3/&q=%s')
