...
if !exists('g:w3m#search_engine')
  if g:w3m#lang == 'ja_JP' || g:w3m#lang == 'ja'
    let g:w3m#search_engine = 'https://search.yahoo.co.jp/search?search.x=1&fr=top_ga1_sa_124&tid=top_ga1_sa_124&ei=' . &encoding . '&aq=&oq=&p=%s'
  else
    let g:w3m#search_engine = 'https://www.google.com/search?ie=' . &encoding . '&q=%s'
  endif
endif
